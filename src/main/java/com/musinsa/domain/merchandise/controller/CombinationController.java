...
public class CombinationController {
    ...
    @GetMapping("/lowest-price")
       ...
       public GetLowestPriceCombinationByBrandResponseDto getLowestPriceCombinationByBrand(@PathVariable String brand) {
           return combinationService.getLowestPriceCombinationByBrand(brand);
